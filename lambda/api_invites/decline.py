"""Request Handler for /invites/decline API Route
...
def lambda_handler(event, context):  # pylint: disable=unused-argument
    ...
    assert "DeclineInvite" in event["requestContext"]["operationName"]
    ...
    if event["httpMethod"] == "POST":
        ...
        try:
            response_json = decline_invite(invite_guid, authorizer_user_guid)
            response_code = 200
...
def decline_invite(invite_guid: str, authorizer_user_guid: str) -> dict:
